...
class Variable:
    ...
    def trace_vinfo(self):
        ...
        return list(map(self._tk.split, self._tk.splitlist(
...
class Misc:
    ...
    def winfo_visualsavailable(self, includeids=0):
        ...
        return list(map(self.__winfo_parseitem, data))
    ...
    def _report_exception(self):
        """Internal function."""
        import sys
        exc, val, tb = sys.exc_info()[0], sys.exc_info()[1], sys.exc_info()[2]
        root = self._root()
    ...
    def pack_slaves(self):
        ...
        return list(map(self._nametowidget,
               self.tk.splitlist(
...
class Wm:
    ...
    def wm_colormapwindows(self, *wlist):
        ...
        if wlist:
            ...
            return list(map(self._nametowidget, self.tk.splitlist(self.tk.call(args))))
...
class Tk(Misc, Wm):
    ...
    def readprofile(self, baseName, className):
        ...
        if os.path.isfile(class_py):
            exec(compile(open(class_py).read(), class_py, 'exec'), dir)
        if os.path.isfile(base_tcl):
            self.tk.call('source', base_tcl)
        if os.path.isfile(base_py):
            exec(compile(open(base_py).read(), base_py, 'exec'), dir)
...
class OptionMenu(Menubutton):
    ...
    def __init__(self, master, variable, value, *values, **kwargs):
        ...
        if 'command' in kwargs:
            del kwargs['command']
        if kwargs:
            raise TclError('unknown option -'+list(kwargs.keys())[0])
...
class Image:
    ...
    def configure(self, **kw):
        """Configure the image."""
        res = ()
        for k, v in list(_cnfmerge(kw).items()):
            if v is not None:
                if k[-1] == '_': k = k[:-1]
                if hasattr(v, '__call__'):
                    v = self._register(v)
